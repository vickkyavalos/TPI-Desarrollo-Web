...
export const eventosExportados = [
    ...
    { idSalon: 3 ,tituloSalon: "Peque Mundo", direccionSalon: "Savio 3000", descripcion: "Zona de juegos blandos, rincón de lectura y mini cine para los chicos", precioSalon:  60000, estadoSalon:"Disponible" }
];
...
export const presupuestos = [
    { idPresupuesto: 1, idUsuario: 16, idSalon: 1, idServicio: [1, 2],  idTematica: 1, fechaReserva: "2025-07-01", total: 135000 },
    { idPresupuesto: 2, idUsuario: 17, idSalon: 2, idServicio: [2, 3],  idTematica: 2, fechaReserva: "2025-07-02", total: 235000 },
    { idPresupuesto: 3, idUsuario: 18, idSalon: 3, idServicio: [1, 3, 4], idTematica: 3, fechaReserva: "2025-07-03", total: 110000 },
    { idPresupuesto: 4, idUsuario: 19, idSalon: 1, idServicio: [3],  idTematica: 4, fechaReserva: "2025-07-04", total: 130000 }
];
